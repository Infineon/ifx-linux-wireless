...
#1. Download the backports package
    wget https://github.com/cypresssemiconductorco/ifx-backports/archive/v5.4.18-2021_0114.zip
    unzip ifx-backports-5.4.18-2021_0114.zip
    cd ifx-backports-5.4.18-2021_0114
...
#1. Download Infineon devicetree package
    wget https://github.com/cypresssemiconductorco/ifx-linux-wireless/archive/v5.4.18-2021_0114.zip
    unzip ifx-linux-wireless-5.4.18-2021_0114.zip
#2. Find your board's dtb file, for example
#      devicetree/iMX6SX/4.14.78/imx6sx-sdb-btwifi-fmac.dtb
```
...
#2. Copy firmware files to the target board
    wget https://github.com/cypresssemiconductorco/ifx-linux-firmware/archive/v5.4.18-2021_0114.zip
    unzip ifx-linux-firmware-5.4.18-2021_0114
...
#1. Download Linux kernel source
    wget https://github.com/cypresssemiconductorco/ifx-wireless-drivers/archive/v5.4.18-2021_0114.zip
    unzip ifx-wireless-drivers-5.4.18-2021_0114
...
#1. Download Hostap source
    wget https://github.com/cypresssemiconductorco/ifx-hostap/archive/2_9-2021_0114.zip
    unzip ifx-hostap-2_9-2021_0114.zip
